...
void loop()
{
  ...
  if( buttonState == 2 && IsActive )
  {
    ...
    {
			case 0:
				Initialize_Mode(CRASHING_WAVE);
				LCD.print("Crashing Wave   ");
				break;
			case 1:
				Initialize_Mode(CROSSING);
				LCD.print("Crossing        ");
				break;
			case 2:
				Initialize_Mode(DOUBLE_HELIX);
				LCD.print("Double Helix    ");
				break;
			case 3:
				Initialize_Mode(FLOPPER);
				LCD.print("Flopper         ");
				break;
			case 4:
				Initialize_Mode(HELIX);
				LCD.print("Helix           ");
				break;
			case 5:
				Initialize_Mode(MULTI_CYCLE);
				LCD.print("Multi Cycle     ");
				break;
			case 6:
				Initialize_Mode(OUTLINE);
				LCD.print("Outline         ");
				break;
			case 7:
				Initialize_Mode(PULSE);
				LCD.print("Pulse           ");
				break;
			case 8:
				Initialize_Mode(RAIN);
				LCD.print("Rain            ");
				break;
			case 9:
				Initialize_Mode(ROTATOR);
				LCD.print("Rotator         ");
				break;
			case 10:
				Initialize_Mode(SIMPLE_CYCLE);
				LCD.print("Simple Cycle    ");
				break;
			case 11:
				Initialize_Mode(SINE);
				LCD.print("Sine            ");
				break;
			case 12:
				Initialize_Mode(SNAKE);
				LCD.print("Snake           ");
				break;
			case 13:
				Initialize_Mode(SPARKLE);
				LCD.print("Sparkle         ");
				break;
			case 14:
				Initialize_Mode(SPLITTER);
				LCD.print("Splitter        ");
				break;
			case 15:
				Initialize_Mode(TETRIS);
				LCD.print("Tetris          ");
				break;
			case 16:
				Initialize_Mode(TURBINE);
				LCD.print("Turbine         ");
				break;
      default:
        break;
